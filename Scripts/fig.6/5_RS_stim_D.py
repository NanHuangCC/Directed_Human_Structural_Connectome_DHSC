...
if __name__ == '__main__':
    ...
    weights = directional_conn.copy() / np.max(directional_conn)
    lengths = directional_conn_len.copy()
    ...
    for region in region_list: # test the first 10 regions
        ...
        dir = "/data3/nh_data/20250204_DirectionalConnectome/dataset/simulation_output/20260323_stim/directed"
