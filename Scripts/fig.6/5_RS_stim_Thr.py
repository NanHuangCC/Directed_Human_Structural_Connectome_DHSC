...
if __name__ == '__main__':
    ...
    weights = sparse_nodirectional_conn.copy() / np.max(sparse_nodirectional_conn)
    lengths = saparse_nodirectional_conn_len.copy()
    ...
    for region in region_list: # test the first 10 regions
        ...
        dir = "/data3/nh_data/20250204_DirectionalConnectome/dataset/simulation_output/20260323_stim/threshold"
        ...
        with mp.Pool(processes=10) as pool:  # 使用8个进程
